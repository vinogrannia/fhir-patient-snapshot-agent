    ...
    return "\n".join(
        [
            ...
            *_required_section_lines(audience_key),
            ...
            "- In Source-data checks or Source-data notes, write neutral statements about what the source data shows.",
            ...
            "- Every explicitly mentioned FHIR resource ID must appear in Source FHIR resources used.",
            "",
            "Source context:",
