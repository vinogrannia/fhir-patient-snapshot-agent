    ...
    return "\n".join(
        [
            ...
            *_required_section_lines(audience_key),
            ...
            "- Use wording such as 'source data shows' or 'source data contains' instead of clinical advice.",
            ...
            "- Keep FHIR resource IDs only in the Source FHIR resources used section.",
            "- Summarise resource details in readable clinical language.",
            ...
            "- Every source resource used to generate the summary must appear in Source FHIR resources used.",
            "",
            "Source context:",
